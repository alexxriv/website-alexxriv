...
export const name = "Alex Terrazas";
export const siteTitle = "Alex Terrazas";
  ...
  return (
    <div className="h-screen flex flex-col ">
        ...
        <div className="container mx-auto sm:grid grid-cols-1 sm:grid-cols-3 sm:mt-28 mt-10 gap-x-5 max-w-5xl mb-2">
          <div className="side-panel sm:text-right text-center pb-5 mb-5 sm:mb-0 border-b sm:border-b-0 sm:pr-8 sm:border-r sm:pl-4 border-gray-200">
            <Image
              ...
              width="100"
              height="100"
              className="rounded-full ml-auto mx-auto"
              quality="100"
            />
            ...
            <p className="text-gray-600">(He / Him)</p>
            <p className="text-gray-600 pt-3">Software Engineer</p>
            <p className="text-gray-600">Universidad Nacional Autónoma de Mexico '24</p>
            ...
            <div className="hidden sm:flex justify-center sm:justify-end mt-5">
              <Obfuscate email="alex.trrzrivera@gmail.com">
                <FontAwesomeIcon icon={faEnvelope} className="w-6 mr-3" />
              </Obfuscate>
              <a href="https://github.com/alexxriv" aria-label="GitHub">
                <FontAwesomeIcon icon={faGithub} className="w-6 mr-3" />
              </a>
              <a
                href="https://www.linkedin.com/in/alex-terrazas"
                aria-label="LinkedIn"
              >
                <FontAwesomeIcon
                  icon={faLinkedin}
      ...
      <footer className="text-center pb-3 mt-5">
        ...
        <p className="text-sm text-gray-500">2023 - Alex Terrazas</p>
      </footer>
    </div>
  );
}
